...
public class Vehicle implements SimplifiedInformer, DetailedInformer
{
    String name;
    String model;
    String manufacturer;
    ...
    public void getInfoList(JsonObject jsonObject, Consumer<HashMap<String, String>> callback)
    {
        ...
        infos.put("Class", jsonObject.get("vehicle_class").getAsString());
